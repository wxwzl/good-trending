 ...
 */
export function createProductFixtures(count: number, overrides: Partial<ProductFixture> = {}): ProductFixture[] {
 ...
 */
export function createTopicFixtures(count: number, overrides: Partial<TopicFixture> = {}): TopicFixture[] {
 ...
 */
export function createTrendFixtures(count: number, overrides: Partial<TrendFixture> = {}): TrendFixture[] {
