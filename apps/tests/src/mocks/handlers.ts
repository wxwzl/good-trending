...
import { createProductFixture, createTopicFixture, createTrendFixture, createPaginatedResponse } from '../fixtures'
...
export const handlers = [
  ...
  http.get(`${API_BASE}/topics`, async ({ request }) => {
    ...
    return HttpResponse.json(createPaginatedResponse(paginatedTopics, mockTopics.length, page, limit))
  }),
