...
CREATE UNIQUE INDEX "product_source_type_id_unique" ON "product" USING btree ("source_type","source_id");--> statement-breakpoint
CREATE UNIQUE INDEX "product_source_type_url_unique" ON "product" USING btree ("source_type","source_url");--> statement-breakpoint
